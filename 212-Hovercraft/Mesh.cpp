...
void Mesh::updateModelMatrix()
{
    ...
    this->ModelMatrix = glm::translate(this->ModelMatrix, this->originPos);
    this->ModelMatrix = glm::rotate(this->ModelMatrix, glm::radians(this->rotation.x), glm::vec3(1.f, 0.f, 0.f));
    this->ModelMatrix = glm::rotate(this->ModelMatrix, glm::radians(this->rotation.y), glm::vec3(0.f, 1.f, 0.f));
    this->ModelMatrix = glm::rotate(this->ModelMatrix, glm::radians(this->rotation.z), glm::vec3(0.f, 0.f, 1.f));
    this->ModelMatrix = glm::translate(this->ModelMatrix, this->position- this->originPos);
...
void Mesh::setOriginPos(const glm::vec3& originPos)
{
    this->originPos = originPos;
}
...
void Mesh::moveOriginPos(glm::vec3 move)
{
    originPos = originPos + move;
}
